/**
 *  코드에프 예제 - 사용자 계정 목록 조회
 *  - https://developer.codef.io/cert/account/list
 *
 * @Company : ©CODEF corp.
...
/*
 * #5.요청 파라미터 설정
 * - 계정관리 파라미터 설정(https://developer.codef.io/cert/account/cid-overview)
 */
const param = {
  connectedId: '9GNB80TmkzNaX-E7.....',
};
/*	#6.요청
 *  [서비스 타입 설정]
 ...
 */
codef
  .getAccountList(EasyCodefConstant.SERVICE_TYPE_SANDBOX, param)
